        ...
        <SimpleBar style={{ height: "900px" }}>
          <div data-simplebar className="h-100">
            <div className="rightbar-title px-3 py-4">
              ...
              >
                <a><i className="mdi mdi-close noti-icon" /></a>
              </Link>
            ...
            <div className="p-4">
              ...
              <div className="mb-2">
                <Link
                  href="//veltrix-v.react.themesbrand.com"
                  target="_blank"
                ><a>
                  <Image
                    src={layout1}
              ...
              <div className="mb-2">
                <Link href="//veltrix-v-dark.react.themesbrand.com" 
                target="_blank">
                  <a>
                  <Image
                    src={layout2}
              ...
              <div className="mb-2">
                <Link href="//veltrix-v-rtl.react.themesbrand.com" 
                target="_blank">
                  <a><Image
                    src={layout3}
                    className="img-fluid img-thumbnail"
              ...
              <Link
                ...
                target="_blank"
              >
               <a> <i className="mdi mdi-cart ms-1" /> Purchase Now</a>
              </Link>
            </div>
          </div>
        </SimpleBar>
